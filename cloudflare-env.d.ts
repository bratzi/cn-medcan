/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 21e24d844fba7a4e4041bbb1c73ade22)
// Runtime types generated with workerd@1.20260921.1 2026-09-22 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	SITE_PASSWORD: string;
	FACHKREIS_PASSWORD: string;
