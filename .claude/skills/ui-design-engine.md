...
- Laufweite: `tracking-gesperrt` (0.3em) in der Unterzeile der Wortmarke und seit 2026-09-25 (Nutzer) für alle Nebentexte im Auftakt (Intro, Kopfzeile) und seit Session 20 für die Kopf-Navigation samt Konto-Pille: `font-sans` Versalien in `text-caption`/`text-small`; sonst kleine Versalien-Zeilen `tracking-wide`.
